    ...
    >
      <div className="@container">
        ...
        <div className="relative w-full mb-2.5 xs:mb-8 md:mb-7.5">
          ...
          {/* Overlaid title */}
          <h1
            className="text-white font-cera font-bold md:text-[11.81cqw] xs:text-[11.5cqw] text-[10.5cqw] md:leading-[9.03cqw] leading-none tracking-[-3%] md:mt-[-0.69em] xs:mt-[-0.82em] mt-[-0.81em] md:ml-0 xs:ml-2.5 ml-2.5 xs:mr-0 mr-5.25 relative z-10 text-left"
          > Behind the&nbsp;Studio
          </h1>
        </div>
