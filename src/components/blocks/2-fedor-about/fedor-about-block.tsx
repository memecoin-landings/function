      ...
      <div className="@container">
        ...
        <div className="">
          ...
          >
            <Link
              href="#"
              className="inline-flex items-left text-white hover:text-[#FF3F1A] border-b border-white hover:border-[#FF3F1A] transition-colors duration-200 pb-1 text-[5vw] sm:text-[3.125cqw] font-medium leading-[6vw] sm:leading-[3.875cqw]"
            >
              Get Price
            </Link>
