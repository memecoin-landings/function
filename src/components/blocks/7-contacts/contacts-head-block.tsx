  ...
  return (
    <div className="relative fluid-container @container text-[#FF3F1A] fill-[#FF3F1A]">
      <Link
        ...
        className="mx-auto block text-centerduration-150 whitespace-nowrap md:text-[7cqw] text-[7.32cqw] tracking-[-3%] underline-offset-[1.9cqw] underline font-medium decoration-solid text-center"
      >
        {Contacts.email}
      </Link>
      <div className="flex flex-row items-center space-x-5 justify-center text-[0.75rem] xs:text-[0.875rem] tracking-[-3%] mt-4.25 xs:mt-7.75 md:mt-12.5 ">
        ...
        <Link
          className="flex flex-row duration-150  font-mediummd:text-[1.25rem] items-center space-x-2.5"
        ...
        <Link
          className="flex flex-row duration-150  font-medium md:text-[1.25rem] items-center space-x-2.5"
