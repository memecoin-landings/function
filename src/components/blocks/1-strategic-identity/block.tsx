...
export default function StrategicIdentityBlock({ className }: { className?: string }) {
  return (
    <section className={`w-full flex flex-col @container max-w-screen overflow-hidden pt-2 pl-2.5 xs:pl-0 ${className}`}>
      ...
      <h2 className="pointer-events-none font-medium md:text-[3.85cqw] xs:text-[4.6875cqw] text-[5.8cqw] md:leading-[4.5cqw] xs:leading-[5.73cqw] leading-[7.2cqw] xs:mt-[calc(-1.75em-2px)] mt-[calc(-1.5em-2px)] relative z-10 md:pl-5 xs:pl-2.5 md:pr-34.5 pr-2.5"
