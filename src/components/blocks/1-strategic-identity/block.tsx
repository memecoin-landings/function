...
export default function StrategicIdentityBlock() {
  return (
    <section className="w-full flex flex-col @container max-w-screen overflow-hidden pt-2">
      <WebGLBlurEffect className="w-full bg-[#151516] pt-[0.1em] text-[18.7cqw] pb-[0.1em]">
        <div className="text-[#FF3F1A] font-bold leading-[16cqw] tracking-[-3%] xs:pl-0"
        >Strategic Identity</div>
      </WebGLBlurEffect>
      <h2 className="text-5xl pointer-events-none @container font-medium text-[3.75cqw] leading-[4.5cqw] mt-[calc(-2em-2px)] relative z-10 pl-5 pr-34.5"
