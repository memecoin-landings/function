...
export default function StrategicIdentityBlock({ className }: { className?: string }) {
  return (
    <section className={`-mt-10 w-full flex flex-col @container max-w-screen overflow-hidden pl-2.5 xs:pl-0 ${className}`}>
      <WebGLBlurEffect className="w-full bg-[#151516] md:text-[19.25cqw] xs:text-[18.23cqw] text-[17.45cqw] pt-10">
        <div className="text-[#FF3F1A] font-bold md:leading-[16cqw] xs:leading-[15.36cqw] tracking-mid leading-[14.65cqw] xs:pl-0 pb-[0.1em]"
