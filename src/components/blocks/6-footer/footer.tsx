...
import WhatsappCircleIcon from "@/components/common/whatsapp-circle-icon"; import { cn } from "@/lib/utils";
  ...
  return (
    <>
      <footer ref={sectionRef} className={cn(className, "w-full bg-black md:pt-25 pt-12.5 relative @container overflow-hidden **:transition-colors")}>
        ...
        <div
          ref={glowEffect}
          className="z-0 absolute left-1/2 w-[110vw] md:blur-[15vw] blur-[400px] md:w-[85vw] h-[85.7cqw] top-[80%] md:top-[70%] bg-cover rounded-[50%] bg-[radial-gradient(circle_at_0%_100%,#FF3F1A_0%,#FF5921_100%)]"
          style={{
            opacity: 0,
