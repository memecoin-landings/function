...
export default function GlowEffect() {
  ...
  return (
    <div
      ref={glowEffect}
      className="z-1 overflow-visible absolute left-1/2 w-[110vw] will-change-[opacity,_transform] md:blur-[15vw] blur-[40px] md:w-[85vw] h-[85.7cqw] bottom-0 bg-cover rounded-[50%] bg-[radial-gradient(circle_at_0%_100%,#FF3F1A_0%,#FF5921_100%)]"
      style={{
