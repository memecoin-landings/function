        ...
        >
          <div className={cn("mx-auto px-5 flex items-center")}>
            ...
            <nav className="hidden sm:flex shrink-0 items-baseline md:space-x-15 space-x-7.5 flex-nowrap">
              ...
              {/* Get Price Button */}
              <button className="hidden sm:block bg-[#F0EDE8] text-[#151516] hover:bg-[#FF3F1A] transition-colors duration-200 py-0.5 rounded-full leading-8.5 px-5 text-sm font-medium text-nowrap">
                Get Price
              </button>
            </nav>
