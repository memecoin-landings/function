  ...
  new Service(
    ...
    [
      ...
      },
      {
        ...
        description:
          "Development of a brand guidelines document with recommendations on the use of visual elements, and the systematization of all brand assets, including logos, fonts, color schemes, and other components.",
    ...
    [
      {
        ...
        description:
          "Ensuring correct application of brand elements across various media and communications in accordance with established standards, as well as regular assessment of brand perception by consumers and analysis of the competitive environment to make timely strategic adjustments.",
      },
      {
  ...
  new Service(
    ...
    [
      ...
      },
      {
        ...
        description:
          "Checking the availability of trademarks. Full legal registration is available through trusted partners in international markets.",
      },
    ]
  ),
  new Service(
    ...
    [
      ...
      },
      {
        ...
        description:
          "Development of a logobook with recommendations on logo usage across various media and in different formats and scales. Includes safe zone guidelines, typography, color palette, and source files in both vector and raster formats.",
