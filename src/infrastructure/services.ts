  ...
  new Service(
    ...
    [
      ...
      },
      {
        ...
        description:
          "Checking the availability of trademarks. Full legal registration is available through trusted partners in international markets. <br/> <br/>The next stage of brand development:<br/> <a href='/services/corporate-identity' target='_blank' class='text-[#FF3F1A] underline'>Corporate identity</a>, <a href='/services/product-identity' target='_blank' class='text-[#FF3F1A] underline'>Product identity</a>, <a href='/services/personal-identity' target='_blank' class='text-[#FF3F1A] underline'>Personal identity</a>, <a href='/services/logo' target='_blank' class='text-[#FF3F1A] underline'>Logo</a>",
      },
    ]
  ),
  new Service(
    ...
    [
      ...
      },
      {
        ...
        nextStages:
          "The next stage of brand development:<br/> <a href='/services/corporate-identity' target='_blank' class='text-[#FF3F1A] underline'>Corporate identity</a>, <a href='/services/product-identity' target='_blank' class='text-[#FF3F1A] underline'>Product identity</a>, <a href='/services/campaign-identity' target='_blank' class='text-[#FF3F1A] underline'>Campaign identity</a>, <a href='/services/personal-identity' target='_blank' class='text-[#FF3F1A] underline'>Personal identity</a>",
      },
    ]
  ),
  new Service(
